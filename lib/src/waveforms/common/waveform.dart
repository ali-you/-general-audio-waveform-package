...
class Waveform extends StatelessWidget {
  const Waveform({Key? key, required this.waveformType, this.waveformStyle, required this.elapsedDuration, required this.maxDuration, this.samples}) : super(key: key);
